...
<body>
	...
	<div id="contents">
		...
		<s:if test="!session.userLoginIdErrorMessageList.isEmpty()">
			<div class="error">
				<div class="error-message">
					<s:iterator value="#session.userLoginIdErrorMessageList">
						<s:property />
						<br>
					</s:iterator>
				</div>
		...
		<s:form action="CreateUserConfirmAction">
			<table class="vertical-list-table">
				...
				<tr>
					...
					<td><s:textfield name="createLoginId" value="%{#session.createLoginId}"
							label="ユーザーID" placeholder="ユーザーID" class="txt" /></td>
				</tr>
				<tr>
